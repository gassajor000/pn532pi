...
from PN532.pn532 import pn532, NDEF_URIPREFIX_HTTP_WWWDOT, NDEF_URIPREFIX_MAILTO, NDEF_URIPREFIX_TEL, \
...
def loop():
  ...
  success, uid = nfc.readPassiveTargetID(cardbaudrate=PN532_MIFARE_ISO14443A_106KBPS)
